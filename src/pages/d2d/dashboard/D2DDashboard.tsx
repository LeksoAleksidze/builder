          ...
          {!isCollapsed && (
              <div className="promotion-card__content">
                ...
                >
                  ...
                  {/* --- Copy Modal --- */}
                  {showCopyModal && (
                      <div className="absolute z-50 right-0 top-10 w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg rounded-xl p-3 animate-fadeIn">
                        ...
                        <div className="flex flex-col gap-2">
                          {links.map((link, i) => (
                              <button
                                  ...
                                  className="flex justify-between items-center px-3 py-2 text-sm bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition"
                              >
  ...
  return (
      <div className="dashboard">
        ...
        <main className="dashboard__main">
          ...
          <div
              className="container mx-auto px-4 py-4 pt-0 flex flex-wrap gap-3 items-center border-b dark:border-gray-700 mb-6">
            <TooltipProvider>
              <Tooltip>
                  ...
                  <Tooltip key={user.userId}>
                    <TooltipTrigger asChild>
                      <button
                          ...
                          className={`w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-medium transition-all duration-200
